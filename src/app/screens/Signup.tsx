...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(error);
      alert("Registration Error: " + (error.message || "Connection to server failed. Please check your Wi-Fi connection."));
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleGoogleSignup = () => {
    alert("Google Sign Up - Mock implementation");
  };
  ...
  return (
    <div className="h-full w-full flex flex-col p-6 overflow-y-auto">
      <div className="flex-1 flex flex-col justify-center py-8">
        ...
        <p className="text-gray-600 mb-8">Sign up to get started with SkinScan AI</p>
        ...
        <button
          ...
          className="w-full border border-gray-300 hover:bg-gray-50 py-3 rounded-xl font-semibold flex items-center justify-center gap-2"
        >
